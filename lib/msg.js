...
m.axl = (teks, id = m.chat, option = { mentions: [m.sender] }) => conn.sendMessage(id, { text: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: ajxal })
	...
	m.sendReact = (teks, id = m.chat, option = { mentions: [m.sender] }) => {
    ...
    m.image = (teks, id = m.chat, option = { mentions: [m.sender] }) => {
        ...
        var ninja = mimmi[1] || '*Image By NEXTRO-MD 🗿*'
